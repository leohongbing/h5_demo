...
<!--      </div>-->
      <div class="nav">
        <ul class="nav-list">
          <li class="nav-item"><a @click="push({name: 'monday'})">周一</a></li>
          <li class="nav-item">
            <a @click="push({name: 'tuesday', query: {name: 'suporka', age: '26'}})">周二</a>
          </li>
          <li class="nav-item"><a @click="push({path: '/wednesday'})">周三</a></li>
          <li class="nav-item">
            <a @click="push({path: '/thursday', query: {name: 'suporka', age: '20'}})">周四</a>
          </li>
          <li class="nav-item"><a @click="replace({name: 'friday'})">周五</a></li>
        </ul>
      </div>
    ...
    <div class="nav-area">
      <button class="nav-area-back" @click="back">后退</button>
      <button class="nav-area-front" @click="front">前进</button>
      <button class="nav-area-front" @click="go">go(-1)</button>
      <button
...
<script>
  import Router from '../../htmlRouter/htmlRouter-dev';
